            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background-image: url(/dashboard/assets/media//bg/bg-4.jpg);">
                <div class="kt-login__section">
                    <div class="kt-login__block">
                        ...
                        <div style="font-family: iranyekan; line-height: 3" class="kt-login__desc">
                            <br> کاهش سیکل زمانی ارتباطات متقابل بین ساکنین و مدیریت برج -
                            <br>                         صرفه جویی در هزینه ها -
                            <br>                          شفاف سازی فرآیندها، هزینه ها و درآمدها -
                            <br>                           دسترسی سریع به گزارشات و آمارهای لازم -
                            <br>                           نظارت همگانی بصورت برخط توسط کلیه مالکین و ساکنین برج -
                            <br>                           سهولت در امر محاسبه دقیق و سریع شارژ واحدهای برج -
                            <br>                           تسریع در محاسبه عملیات مالی برج -
                            <br>                           ... و  -
                        </div>
                    </div>
                </div>
