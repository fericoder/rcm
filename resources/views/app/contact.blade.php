            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="text-white mb-0">تماس باما</h1>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                        <div class="card-body py-5">
                            ...
                            <div><h5 class="mb-0">تلفن</h5>
                                <p class="text-muted mb-0">021-22321250</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                        <div class="card-body py-5">
                            ...
                            <div><h5 class="mb-0">آدرس </h5>
                                <p class="text-muted mb-0">  مجتمع اداری 14 معصوم (ع) </p></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                        <div class="card-body py-5">
                            ...
                            <div><h5 class="mb-0">ایمیل</h5>
                                <p class="text-muted mb-0">Info@site.com</p></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="card single-promo-card single-promo-hover text-center shadow-sm">
                        <div class="card-body py-5">
                            ...
                            <div><h5 class="mb-0">چت</h5>
                                <p class="text-muted mb-0">کلیک کنید</p></div>
                        </div>
                    </div>
                </div>
            </div>
